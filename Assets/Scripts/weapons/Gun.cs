...
public class Gun : MonoBehaviour {
	...
	public void LaunchProjectile()
	{
		...
		grenadeObj.soldierCamera = mainCamera;
	...
	{
		HitType hitType = HitType.GENERIC;
		...
		{
			go = GameObject.Instantiate(bulletMark, hit.point, Quaternion.FromToRotation(Vector3.forward, -hit.normal)) as GameObject;
