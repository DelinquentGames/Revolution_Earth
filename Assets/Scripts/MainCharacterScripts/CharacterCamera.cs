...
public class CharacterCamera : MonoBehaviour
{
	...
	public Transform camMount = null;
    ...
    void Start ()
    {
		...
		hCtrl = GetComponent <CharacterCtrl>() as CharacterCtrl;
...
//		camInput.do3rdP = Input.GetKeyDown ("3");
	...
	void FirstPerson ()
	{
    	...
    	// Camera position
		Vector3 camPos = camMount.position - (cam.forward * desDist) - (cam.up * -heroHeight /4);
