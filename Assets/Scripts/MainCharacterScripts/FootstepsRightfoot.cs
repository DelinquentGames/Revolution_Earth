/// <summary>
/// FootstepsRightfoot.cs
/// Adam T. Davis
/// 01/20/2014
/// 
/// Handles all of the audio for the footsteps of the right foot hitting the ground.
/// </summary>
using UnityEngine;
using System.Collections;

public class FootstepsRightfoot : MonoBehaviour {
	...
	void OnTriggerEnter (Collider col) {
		//NGUIDebug.Log("Right Foot hit ground!");
		if(anim == null){
