...
public class IndustryLoader : MonoBehaviour {
    ...
    IEnumerable LoadIndustry()
    {
        float progress = Application.GetStreamProgressForLevel("Tutorial");
        ...
        else
        {
            ...
            while(!con.isDone)//progress < 1.0)
            {
                ...
                progress = Application.GetStreamProgressForLevel("Tutorial");
                yield return industryProgress;
            }
