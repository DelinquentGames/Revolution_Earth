...
public class UILabel : UIWidget
{
	...
	public void SetCurrentProgressDecimal ()
	{
		if (UIProgressBar.current != null)
		{
			text = (UIProgressBar.current.value * 100f).ToString("F");
		}
	}
	...
	public void SetCurrentQuality ()
	{
		if (UIProgressBar.current != null)
		{
			...
			switch((int)(UIProgressBar.current.value * 10)){
			case 0:
				text = tempstring[0];
				break;
			case 2:
	...
	public void SetCurrentTextureQuality ()
	{
		if (UIProgressBar.current != null)
		{
			string[] tempResolution = {"FULL RESOLUTION", "HALF RESOLUTION", "QUARTER RESOLUTION", "1/8 RESOLUTION"};
			switch((int)(UIProgressBar.current.value * 100)){
			case 0:
				text = tempResolution[0];
				break;
			case 33:
				text = tempResolution[1];
				break;
			case 66:
				text = tempResolution[2];
				break;
			case 100:
				text = tempResolution[3];
				break;			
			}
		}
	}
	...
	public void SetCurrentAALevel ()
	{
		if (UIProgressBar.current != null)
		{
			string[] tempString = {"Disabled", "2x Multi Sampling", "4x Multi Sampling", "8x Multi Sampling"};
			switch((int)(UIProgressBar.current.value * 100)){
			case 0:
				text = tempString[0];
				break;
